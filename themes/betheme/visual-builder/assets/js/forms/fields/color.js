function mfn_field_color(field = false) {
	...
	html += `<div class="form-group color-picker has-addons has-addons-prepend">
		<div class="color-picker-group">
			<div class="form-addon-prepend"><a href="#" class="color-picker-open"><span ${ value != '' ? `style="background-color: ${value}; border-color: ${value};"` : '' } class="label ${getContrastYIQ( value )}"><i class="icon-bucket"></i></span></a></div>
